...
use crate::activity_facts::ActivityFacts;
use crate::analytics;
...
#[cfg(test)]
use savings::{
    lifetime_token_milestones_crossed, lifetime_usd_milestones_crossed, local_hour_key,
    parse_headroom_stats_from_json, parse_headroom_stats_history_from_json, DailySavingsBucket,
    HeadroomSavingsHistoryPoint, PersistedSavingsState, SavingsObservation,
};
...
impl AppState {
    ...
    pub(crate) fn new_in(base_dir: PathBuf) -> Result<Self> {
        ...
        let state = Self {
            ...
            headroom_learn_state: Mutex::new(HeadroomLearnRuntimeState::default()),
...
mod tests {
    ...
    use crate::models::{
        ActivityEvent, DailySavingsPoint, HourlySavingsPoint, RuntimeUpgradeFailure,
        SavingsAttributionConfidence, SavingsAttributionSource, UpgradeFailurePhase,
    };
