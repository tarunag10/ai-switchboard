...
pub(crate) const PLANNED_CLIENT_SPECS: [PlannedClientSpec; 11] = [
    ...
    PlannedClientSpec {
        ...
        category: "agent",
        setup_phase: "managed",
        setup_hint: "Managed openai-api-base routing and Switchboard-owned sidecar with Doctor verify, rollback, and Off mode cleanup.",
        ...
        automation_gates: &[
            ...
            "Verify Doctor repair, rollback, and Off mode cleanup leave API keys and unrelated settings untouched.",
        ],
        manual_workflow: &[
            "Confirm Aider is installed.",
            "Toggle the connector on from Settings to apply managed endpoint routing and the sidecar.",
            "Keep API keys in your existing config or .env file.",
        ],
    },
    PlannedClientSpec {
        id: "continue",
        ...
        category: "editor",
        setup_phase: "managed",
        setup_hint: "Managed config.yaml model routing and Switchboard-owned sidecar with Doctor verify, rollback, and Off mode cleanup.",
        detection_sources: &["~/.continue", "~/Library/Application Support/Continue"],
        config_locations: &["~/.continue", "~/.continue/config.yaml"],
        automation_gates: &[
            "Detect active Continue config without reading secrets.",
            "Back up ~/.continue/config.yaml before managed model edits.",
            "Write only the allowlisted Headroom model entry and Switchboard-owned sidecar.",
            "Verify Doctor repair, rollback, and Off mode cleanup leave provider credentials untouched.",
        ],
        manual_workflow: &[
