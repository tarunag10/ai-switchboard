...
- Durable savings attribution now records estimated Repo Intelligence best-pack token-avoidance events after successful index builds, and inferred MarkItDown, Ponytail, Caveman, and Compact Chinese template events when those add-ons are enabled.
