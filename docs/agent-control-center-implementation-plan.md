...
- Repo-memory MCP now has an app-facing lifecycle status contract in the Mode Inspector and Doctor timeline copy, including a direct install action, smoke-check command, read-only tool names, and secret-exclusion safety boundary.
