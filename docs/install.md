...
If a client hits a large-request issue such as `413 Payload Too Large: compression_refused`, use RTK-only mode or compact the conversation, then let Doctor reset the Codex bypass.
