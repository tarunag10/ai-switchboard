...
Run `npm run release:check` before publishing. The release gate runs semantic color checks, a production frontend build, frontend coverage, and desktop tests.
