...
export const plannedAddons: PlannedAddon[] = [
  ...
  },
  {
    ...
    statusLabel: "Planned",
    description:
      "Future connector layer popular coding CLIs editor agents beyond Claude Code Codex, including Gemini CLI, OpenCode, Cursor, Grok / xAI CLI, Aider, Continue, Goose, Qwen Code, Amazon Q Developer CLI, Windsurf, Zed AI.",
    bullets: [
      ...
      "Keep Off-mode cleanup, backups, Doctor repair actions consistent Claude Code Codex.",
      "Expose RTK Repo Intelligence context packs agent-style tools where direct Headroom routing is not supported.",
    ],
    healthChecks: [
      "Detected tools stay read-only unless managed adapter explicitly supported.",
      "Every planned connector shows config surfaces, automation gates, manual workflow.",
      "Doctor keeps planned connector tasks manual excludes Repair all.",
      "Off mode must remove only Switchboard-owned changes before any future adapter writes config.",
    ],
    savingsSources: [
      "RTK-only shell-output savings tools without safe LLM routing.",
      "Repo Intelligence handoff packs copy-only agents and editors.",
      "Manual provider routing until backup, restore, account/model compatibility checks proven.",
    ],
