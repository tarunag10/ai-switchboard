...
export const termsOfUseParagraphs = [
  ...
  "Remote model providers, update checks, telemetry, and support links are separate services unless explicitly labeled as Mac AI Switchboard-owned. Mac AI Switchboard does not include remote account, billing, checkout, or paid pricing APIs.",
];
