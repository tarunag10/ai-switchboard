...
export const SELECTIVE_ACTIVATION_TOOLS: readonly ActivationToolDefinition[] = [
  ...
  { id: "repo-intelligence", label: "Repo Intelligence", description: "Refresh the local repository graph and context summary.", kind: "refresh", actionLabel: "Refresh index", scope: "Local, read-only repository metadata and bounded packs." },
  ...
  { id: "ponytail", label: "Ponytail", description: "Enable the managed Ponytail context integration.", kind: "addon", actionLabel: "Enable Ponytail", scope: "Managed local integration; registered hosts remain visible in Addons." },
