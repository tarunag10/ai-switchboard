...
export const managedChangeRecords: ManagedChangeRecord[] = [
  ...
  },
  {
    ...
    text: "Managed Windsurf editor settings routing.",
    paths: [
    ...
    lastVerifiedLabel: "Verified by Doctor connector checks",
    rollback:
      "Restore the sibling Windsurf settings backup or remove only the managed Windsurf routing keys and markers.",
  },
  {
    id: "zed-ai-routing",
    kind: "client_config",
    ...
    lastVerifiedLabel: "Verified by Doctor connector checks",
    rollback:
      "Restore the sibling Zed settings backup or remove only the managed Zed routing keys and markers.",
  },
  {
    id: "managed-hooks",
    kind: "shell_hook",
  ...
  },
  {
    ...
    kind: "plugin",
    owner: "Add-ons",
    text: "Ponytail bundled-guidance receipt and managed client blocks.",
    paths: [],
    ...
    rollback:
      "Remove the Switchboard-receipted Ponytail guidance blocks; leave unrelated client instructions and user-owned plugins untouched, and keep backup-file sweeping manual until a stricter allowlist exists.",
  },
];
...
export function buildManagedRollbackUndoAllPreview(
  ...
  return {
    ...
    safetyNotes: [
      ...
      "Executable rows are limited to backend-allowlisted Codex, Gemini, OpenCode, Aider, Continue, Windsurf, Zed, and retained managed connector sidecar rollback paths.",
