...
const required = [
  ...
  "scripts/oss-harness-replay.mjs",
  "scripts/oss-harness-replay.node-test.mjs",
  "tests/fixtures/oss-harness/replay-golden.json",
  "src-tauri/src/oss_harness_replay.rs",
  "src-tauri/src/oss_capabilities.rs",
  "src-tauri/src/workbench_kernel/mod.rs",
  "src/lib/ossCapabilities.ts",
  "src/lib/ossHarnessReplay.ts",
  "src/lib/ossHarnessReplay.test.ts",
