...
const requiredFiles = [
  ...
  "fixtures/god-file-registry.json",
  "docs/world-class-token-savings/COMPREHENSIVE-TOKEN-COMPRESSION-IMPLEMENTATION-PLAN.md",
  "docs/world-class-token-savings/COMPRESSION-ROLLBACK-OFF-MODE.md",
  ...
  "scripts/codex-probe-helper-bundle.node-test.mjs",
  "scripts/verify-release.sh",
  "scripts/check-release-env.mjs",
  "scripts/check-release-env-selftest.mjs",
  "scripts/check-release-readiness.mjs",
  "scripts/release-readiness-actions.mjs",
  ...
  "scripts/check-local-mode-relaunch-summary.mjs",
  "scripts/local-mode-relaunch-contract.mjs",
  ...
  "scripts/check-repo-intelligence-map-context.mjs",
...
const requiredScripts = {
  "package.json": [
    ...
    '"smoke:mode-relaunch:local:check"',
    ...
    '"check:repo-intelligence-map"',
    '"check:connectors"',
    '"check:codex-probe-helper-bundle"',
    '"check:branding"',
    '"check:colors"',
    ...
    '"check:switchboard-cli"',
    '"export:benchmark-leaderboard"',
    '"fmt:desktop"',
  ],
  ".codex/environments/environment.toml": [
...
const requiredDocSignals = {
  ...
  "README.md": [
    ...
    "Windsurf",
    "Aider, Continue",
    "Qwen Code, Amazon Q Developer CLI, Zed AI",
    "Cursor, Grok / xAI CLI",
    "docs/remote-destinations.md",
    "docs/connectors.md",
  ...
  "docs/connectors.md": [
    ...
    "Windsurf",
    "OpenCode",
    "dry-run target/marker preview",
    "Managed editor settings routing",
    "Managed assistant settings routing",
    "Automation Gates",
  ],
  "docs/remote-destinations.md": [
    "Local-Only Boundary",
  ...
  "docs/macos-release.md": [
    ...
    "installed bundle path is the canonical",
    "Mac-AI-Switchboard_<version>.dmg",
    "npm run smoke:preflight",
...
const requiredSourceSignals = {
  ...
  "src-tauri/src/doctor.rs": [
    ...
    "automatic provider routing is not enabled for these tools yet",
    "Backend checks:",
  ...
  "src/components/SwitchboardDoctorPanel.manual.test.tsx": [
    "Auto-fix will leave approval-only steps visible",
    "1 automatic",
    "1 approval",
...
const dmgScriptSignals = {
  "scripts/build-macos-dmg.sh": [
    ...
    "import-macos-signing-certificate.sh",
    "cleanup-macos-signing-keychain.sh",
  ...
  "scripts/build-install-local-dmg.sh": [
    ...
    "Refusing to replace an app not owned by AI Switchboard",
