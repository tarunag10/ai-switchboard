...
const requiredDocSignals = {
  ...
  "README.md": [
    ...
    "Cursor",
    "Windsurf",
    "Aider, Continue, Qwen Code, Amazon Q Developer CLI, Zed AI, Grok / xAI CLI",
    "docs/remote-destinations.md",
    "docs/connectors.md",
...
const requiredSourceSignals = {
  ...
  "src-tauri/src/lib.rs": [
    ...
    "keeps native/provider routing manual until their backup, verify, rollback, and Off mode cleanup evidence is promoted",
    "Backend checks:",
